...
class BaseCategoryCell: UICollectionViewCell {
    ...
    private func configureShadow() {
        ...
        let shadowView = UIView(frame: CGRect(x: BaseCategoryCell.kInnerMargin,
                                              y: BaseCategoryCell.kInnerMargin,
                                              width: bounds.width - (2 * BaseCategoryCell.kInnerMargin),
                                              height: bounds.height - (2 * BaseCategoryCell.kInnerMargin)))
