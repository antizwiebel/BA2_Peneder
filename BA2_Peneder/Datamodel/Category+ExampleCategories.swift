...
/// Utility methods for example categories and reading categories from a JSON file
extension Category {
    
    ///Used to retrieve fully defined categories from a JSON file included in the app.
    /// - Returns: a set of rules defined in the file
    static func readExampleCategories () -> [Category]?{
        
        //Use example JSON file from project structure for now
    ...
    /**
     Retrieve an array of CategoryItems from a given JSON array.
    */
    ...
    /**
     Retrieve an array of FuzzyValues from a given JSON array.
     */
    ...
    /// sets a default crisp value for each item of the example categories when the user opens the app first.
    ...
    /// - Returns: a set of four categories plus items for testing
