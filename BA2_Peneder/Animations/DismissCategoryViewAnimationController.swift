//
//  DismissCategoryViewAnimationController.swift
//  BA2_Peneder
//
...
internal class DismissStoryViewAnimationController: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        guard let fromViewController = transitionContext.viewController(forKey: .from) as? CategoryDetailTableViewController,
            let toViewController = transitionContext.viewController(forKey: .to) as? CategoryListViewController else {
                return
        }
